...
def api_get_official_details(request, official_id):
    ...
    try:
        ...
        official_data = {
            ...
            'service_card_proof': f'http://localhost:8000{official.service_card_proof.url}' if official.service_card_proof else None,
    ...
    try:
        ...
        for team_member in team_members:
            members_data.append({
                ...
                'document_proof': f'http://localhost:8000{team_member.document_proof.url}' if team_member.document_proof else '',
    ...
    try:
        ...
        response_data = {
            ...
            'sub_authority': {
                ...
                'document_proof': f'http://localhost:8000{sub_authority.document_proof.url}' if sub_authority.document_proof else '',
    ...
    try:
        ...
        for member in team_members:
            team_members_data.append({
                ...
                'designation': member.designation or '',
                'document_proof': f'http://localhost:8000{member.document_proof.url}' if member.document_proof else '',
                'can_view_reports': member.can_view_reports,
                'can_approve_reports': member.can_approve_reports,
                'can_manage_teams': member.can_manage_teams,
